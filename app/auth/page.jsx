          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                Masuk ke Aplikasi Admin Studio Gallery
              </h2>
              <form>
                <div className="mb-4">
                ...
                <div className="mb-6">
                  <button
                    ...
                    className="flex flex-col items-center justify-center w-full bg-primary py-5 text-white rounded-lg hover:bg-opacity-90 "
                  >
                    Sign In
                  </button>
                </div>
